...
public enum MockResultCode implements ResultCode {
    ...
    D3("888888888", ResultCodeType.SUCCESS, "D3成功", "成功文案"),

    R1("111111111", ResultCodeType.UNKOWN, "X失败", "S1失败文案"),
    R2("222222222", ResultCodeType.FAIL, "X失败", "S2失败文案"),
    R3("333333333", ResultCodeType.FAIL, "X失败", "S3失败文案"),
    R4("444444444", ResultCodeType.SUCCESS, "成功", "成功文案");
